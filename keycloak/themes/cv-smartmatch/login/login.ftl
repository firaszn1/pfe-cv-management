            ...
            <div id="kc-form-wrapper">
                <#if realm.password>
                    <form id="kc-form-login" onsubmit="login.disabled = true; return true;" action="${url.loginAction}" method="post">
                        ...
                        <div class="cv-register-cta">
                            <p>Need access as an HR user? Submit a request and an admin will review it.</p>
                            <a href="${(client.baseUrl!'http://localhost:4200')}/register">Request HR account</a>
                        </div>
                    </form>
                </#if>
            </div>
